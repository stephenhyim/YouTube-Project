...
v1_file = open("https://s3.amazonaws.com/youtube-seeds/video1.mp4")
...
v2_file = open("https://s3.amazonaws.com/youtube-seeds/video2.mp4")
...
v3_file = open("https://s3.amazonaws.com/youtube-seeds/video3.mp4")
...
v4_file = open("https://s3.amazonaws.com/youtube-seeds/video4.mp4")
...
v5_file = open("https://s3.amazonaws.com/youtube-seeds/video5.mp4")
...
v6_file = open("https://s3.amazonaws.com/youtube-seeds/video6.mp4")
...
v7_file = open("https://s3.amazonaws.com/youtube-seeds/video7.mp4")
...
v8_file = open("https://s3.amazonaws.com/youtube-seeds/video8.mp4")
...
v9_file = open("https://s3.amazonaws.com/youtube-seeds/video9.mp4")
